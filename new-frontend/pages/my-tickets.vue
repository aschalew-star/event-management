            ...
            <div class="p-5">
              ...
              <div class="pt-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                ...
                <button 
                  ...
                  :disabled="removingBookmark === bookmark.event.id"
                  class="w-8 h-8 rounded-full bg-red-50 dark:bg-red-950/30 text-red-500 hover:text-white hover:bg-red-500 dark:hover:bg-red-600 flex items-center justify-center transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  title="Remove Bookmark"
                  aria-label="Remove bookmark"
                >
                  <i :class="removingBookmark === bookmark.event.id ? 'fas fa-spinner fa-spin' : 'fas fa-trash-alt'" class="text-xs"></i>
                </button>
              </div>
            </div>
          </div>
...
const removingBookmark = ref<string | null>(null)
...
const removeBookmark = async (eventId: string) => {
  ...
  removingBookmark.value = eventId
